...
__global__ void __launch_bounds__(block_size) ctwc_a2_forward_kernel(
    ...
    for (uint64_t i = 0; i < k; ++i) {
        ...
        const float cos_dist = (1.0f-(similarity + 1.0f)*0.5f)*scale;
...
void ctwc_a2_forward(
    ...
    ctwc_a2_forward_kernel<block_size>
