...
__global__ void __launch_bounds__(block_size) ctwc_a4_1_forward_kernel(
    ...
    for (uint64_t i = 0; i < k; ++i) {
        ...
        const float final_weight = (gaussian_xyz+gaussian_was)*gaussian_cos;
        // 读取邻居点特征并应用权重
...
void ctwc_a4_1_forward(
    ...
    ctwc_a4_1_forward_kernel<block_size>
